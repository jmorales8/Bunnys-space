...
const dialog: string[] = ["Sure!", "Of course!", "Join here :3"]
              ...
              <div className="flex flex-col justify-center pl-3 ">
                <div className="flex flex-row items-center justify-center gap-4">
                  <Image
                    ...
                    loading="eager"
                  />
                  <div className="w-1/2 flex ml-[-175px] z-10 flex-col mr-15 animate-1s mt-[-25px]">
                    <Modal direction="left" width={"100%"} height={250}>
                      <Image
                        src={`/dialogue${dialogOptions}.png`}
                        alt="text"
                ...
                <div className="flex items-center justify-center h-full mt-15 ">
                  <button
                    onClick={() => handleNextDialog()}
                    className={buttonStyle}
                  >
